...
from keras.api.initializers import he_uniform
...
classifier.add(Dense(units=64, kernel_initializer=he_uniform(), activation='relu', input_dim=x_train.shape[1]))
 # Numero de colunas (previsores_encoder.shape[1])
...
# função de ativação Sigmoid é muito eficaz em problemas de classificação binaria  porque ela transforma os valores de saída da rede neural em probabilidades.
